...
export const SocialProof: React.FC = () => {
  ...
  return (
    <div className="w-full overflow-hidden select-none">
      ...
      {/* Headline Section - Reduzierter Abstand nach unten für kompaktere Banner-Optik */}
      <div className="pb-10 md:pb-14 lg:pb-16 px-6">
      ...
      <div className="relative flex overflow-hidden group py-0">
        <div className="animate-marquee-scroll flex items-center gap-20 md:gap-40 lg:gap-56 whitespace-nowrap min-w-max px-20 py-4">
